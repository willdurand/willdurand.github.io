...
2. [Don't Use The ELSE Keyword](#don-t-use-the-else-keyword)
...
6. [Don't Abbreviate](#don-t-abbreviate)
...
9. [No Getters/Setters/Properties](#no-getters/setters/properties)
